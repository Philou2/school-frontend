...
@Component({
  selector: 'app-calenderCurrent',
  templateUrl: './calenderCurrent.component.html',
  styleUrls: ['./calenderCurrent.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class CalenderCurrentComponent implements OnInit {
...
testing(): void{
  ...
  loadEvents(id: number): void {
    ...
    this.ds.getEventsCurrent(from, to).subscribe(result => {
      this.events = result;
    });
  }
