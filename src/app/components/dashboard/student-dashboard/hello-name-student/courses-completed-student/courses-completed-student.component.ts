...
@Component({
  selector: 'app-courses-completed-student',
  templateUrl: './courses-completed-student.component.html',
  styleUrls: ['./courses-completed-student.component.scss']
})
export class CoursesCompletedStudentComponent {
