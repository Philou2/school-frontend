...
@Component({
  ...
  templateUrl: './today-teacher-course-plan-add-edit.component.html',
  styleUrls: ['./today-teacher-course-plan-add-edit.component.scss']
})
export class TodayTeacherCoursePlanAddEditComponent {
