...
import {AdminTeacherCoursePlanAddEditComponent} from './admin-teacher-course-plan-add-edit/admin-teacher-course-plan-add-edit.component';
...
@Component({
  ...
  templateUrl: './admin-teacher-course-plan.component.html',
  styleUrls: ['./admin-teacher-course-plan.component.scss']
})
export class AdminTeacherCoursePlanComponent implements OnInit {
  ...
  addTimeTableModelDayCell() {
    const modalRef = this.modalService.open(AdminTeacherCoursePlanAddEditComponent);
