...
@Component({
  selector: 'app-request-course-permutation-admin',
  templateUrl: './request-course-permutation-admin.component.html',
  styleUrls: ['./request-course-permutation-admin.component.scss']
})
export class RequestCoursePermutationAdminComponent implements OnInit {
  ...
  putValidate(id: number): any {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.requestCoursePermutationService.putValidate(id).subscribe({
          next: (res) => {
  ...
  putReject(id: number): any {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.loadingIndicator = true;
        this.requestCoursePermutationService.putReject(id).subscribe({
          next: (res) => {
