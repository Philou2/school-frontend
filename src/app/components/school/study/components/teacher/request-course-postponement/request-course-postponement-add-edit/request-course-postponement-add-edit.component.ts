...
@Component({
  ...
  templateUrl: './request-course-postponement-add-edit.component.html',
  styleUrls: ['./request-course-postponement-add-edit.component.scss']
})
export class RequestCoursePostponementAddEditComponent {
  ...
  constructor(private fb: FormBuilder,
              private requestCoursePostponementService: RequestCoursePostponementService,
  ...
  onFormSubmit(): any {
    ...
    if (this.requestForm.valid) {
      this.saving = true;
      if (this.data) {
        this.requestCoursePostponementService.put(this.data.id, this.requestForm.value).subscribe({
          next: (val: any) => {
            this.saving = false;
        ...
        this.requestCoursePostponementService.post(this.requestForm.value).subscribe({
          next: (val: any) => {
            this.saving = false;
