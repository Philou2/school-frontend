...
import {RequestCoursePostponementAddEditComponent} from './request-course-postponement-add-edit/request-course-postponement-add-edit.component';
...
@Component({
  selector: 'app-request-course-postponement',
  templateUrl: './request-course-postponement.component.html',
  styleUrls: ['./request-course-postponement.component.scss']
})
export class RequestCoursePostponementComponent implements OnInit {
  ...
  addRequest() {
    const modalRef = this.modalService.open(RequestCoursePostponementAddEditComponent);
